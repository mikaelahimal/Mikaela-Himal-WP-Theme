 ...
 */
 function mikaelahimal_theme_scripts() {
     wp_enqueue_style( 'mikaelahimal', get_stylesheet_uri() );
 }
 add_action( 'wp_enqueue_scripts', 'mikaelahimal_theme_scripts' );
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'mikaela-himal' ),
            'footer-menu' => __( 'Footer Menu', 'mikaela-himal' ),
            'social-menu' => __( 'Social Menu', 'mikaela-himal'),
    ...
    function mikaelahimal_theme_init(){
    ...
    add_action( 'widgets_init', 'mikaelahimal_widgets_init' );
